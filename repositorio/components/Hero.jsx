...
const Hero = () => {
    return (
        <div className='h-screen w-screen overflow-hidden relative flex justify-center items-center'>
            ...
            <div className='flex items-center justify-center flex-col lg:w-[60vw] md:w-[50vw] sm:w-[85vw] text-center z-10'>
                <p className='uppercase text-slate-300 mb-4 text-sm'>Dynamic Web Magic with Next.js</p>
                <h2 className='lg:text-6xl md:text-6xl sm:text-5xl sm:leading-[60px] font-bold mb-10'>Transforming Concepts into Seamless <span className='text-purple-300'>User Experiences</span></h2>
