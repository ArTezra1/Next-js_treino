        ...
        <nav className='flex justify-center z-10'>
            ...
            scrollDirection == "up" || placeholder == 0 ?
                <motion.div initial={{
                    ...
                    borderRadius: 10,
                    opacity: 1
                }} className="p-5 flex items-center justify-center bg-gradient-to-r from-slate-900 to-slate-950 fixed border border-slate-800 border-t-slate-800 border-l-slate-700 lg:w-[50vh] md:w-[60vh] sm:w-[60vh]"
                >
